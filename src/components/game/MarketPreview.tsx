...
const AVAILABLE_MARKETS = new Set(["crypto", "forex", "stocks", "commodities"]);
    ...
    <div className="space-y-5">
      ...
      {allVisited ? (
        <section className="rounded-2xl border border-tp-gold/30 bg-[linear-gradient(135deg,rgba(240,192,64,.10),rgba(19,24,39,.9))] p-4">
          ...
          <p className="mt-1 text-xs text-tp-text-muted">Esta elección define la próxima ciudad educativa. Por ahora las rutas cripto, forex, acciones y materias primas están abiertas: las demás ciudades se inaugurarán en próximas actualizaciones.</p>
