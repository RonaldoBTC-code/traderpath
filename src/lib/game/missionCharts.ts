...
export const MISSION_CHARTS: Record<string, MissionChartConfig> = {
  ...
  m3f_1: {
    symbol: "EUR/USD",
    timeframe: "1H",
    title: "Liquidez según la sesión activa",
    teachingPoint: "El rango de las velas se contrae fuera de los overlaps y se expande cuando dos sesiones coinciden.",
    pattern: "volatile",
    analysis: "volatility",
  },
  m3f_2: {
    symbol: "GBP/USD",
    timeframe: "4H",
    title: "Distancia del stop en pips",
    teachingPoint: "El tamaño de posición depende de cuántos pips hay entre la entrada y el Stop Loss, no de una cifra fija.",
    pattern: "reversal",
    analysis: "risk",
  },
  m3f_3: {
    symbol: "CORRELACIÓN",
    timeframe: "MATRIZ",
    title: "Dos pares no siempre son dos riesgos distintos",
    teachingPoint: "Esta misión compara pares entre sí; el gráfico de precio individual no captura la relación.",
    pattern: "sideways",
    analysis: "range",
    hidden: true,
  },
  m3f_4: {
    symbol: "USD/JPY",
    timeframe: "15min",
    title: "El spread se ensancha antes del dato",
    teachingPoint: "Minutos antes de una publicación de alto impacto, el rango y el spread suelen expandirse de forma anómala.",
    pattern: "breakout",
    analysis: "breakout-retest",
  },
  m3f_5: {
    symbol: "GBP/USD",
    timeframe: "4H",
    title: "Análisis integrado con invalidación — Forex",
    teachingPoint: "Sesión, correlación, noticias y riesgo en pips deben apuntar a la misma hipótesis.",
    pattern: "breakout",
    analysis: "integrated",
  },
  m3s_1: {
    symbol: "SP500",
    timeframe: "1D",
    title: "Capitalización y sectores, no solo precio",
    teachingPoint: "El tamaño de una empresa (large/mid/small cap) y su sector determinan liquidez y volatilidad esperada.",
    pattern: "sideways",
    analysis: "range",
    hidden: true,
  },
  m3s_2: {
    symbol: "AAPL",
    timeframe: "1D",
    title: "El gap del día de resultados",
    teachingPoint: "Un reporte de earnings puede generar un salto de apertura que ningún Stop Loss intermedio puede prevenir.",
    pattern: "breakout",
    analysis: "breakout-retest",
  },
  m3s_3: {
    symbol: "KO",
    timeframe: "1D",
    title: "El ajuste técnico ex-dividendo",
    teachingPoint: "El precio se ajusta a la baja en la fecha ex-dividendo aproximadamente por el monto pagado — no es una pérdida real.",
    pattern: "sideways",
    analysis: "range",
  },
  m3s_4: {
    symbol: "XLK/XLU",
    timeframe: "1W",
    title: "Rotación entre sectores cíclicos y defensivos",
    teachingPoint: "El liderazgo relativo entre sectores cambia según la fase del ciclo económico.",
    pattern: "cycle",
    analysis: "market-cycle",
    hidden: true,
  },
  m3s_5: {
    symbol: "NVDA",
    timeframe: "4H",
    title: "Análisis integrado con invalidación — Stocks",
    teachingPoint: "Sector, concentración, earnings y riesgo en acciones deben apuntar a la misma hipótesis.",
    pattern: "breakout",
    analysis: "integrated",
  },
};
