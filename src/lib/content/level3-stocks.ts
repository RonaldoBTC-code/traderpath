...
export const level3Stocks: Level3StocksConfig = {
  ...
  missions: [
    // ── MISIÓN 3S.1 — El Mapa de Capital Corporativa ──
    {
      ...
      description: "Primera misión en Capital Corporativa. En el laboratorio moverás tú mismo la capitalización de una empresa y verás emerger su categoría — small, mid o large cap — junto con lo que implica en liquidez y volatilidad, hasta inducir por qué el tamaño de una empresa no es solo una etiqueta.",
      learningObjectives: [
        "Inducir, moviendo la capitalización, cómo cambia la liquidez y la volatilidad esperada",
        "Calcular la capitalización (precio × acciones) y distinguir large, mid y small cap",
      ...
      outroDialogues: [
        { id: "m3s1_outro_1", character: "aria", type: "tip", text: "Lo viste en el medidor: cuanto más pequeña la empresa, más volátil y menos líquida; cuanto más grande, más estable. Un índice como el S&P 500 lleva esa idea al extremo — es una canasta de cientos de empresas, así que una mala noticia de una sola se diluye entre las demás." },
      ...
      minigame: {
        id: "mg_m3s1", type: "level_lab", title: "El Mapa de Capitalización",
        description: "Mueve la capitalización de mercado de una empresa y observa qué categoría emerge y qué implica en liquidez y volatilidad.",
        instructions: "Explora el control y mira la etiqueta. Luego resuelve los retos moviendo la capitalización a cada extremo.",
        config: {
          region: "meter",
          regionLabel: "Capitalización de mercado",
          thresholdAt: 10,
          roleName: "",
          inputs: [
            { key: "cap", label: "Capitalización de mercado ($ mil millones)", min: 0, max: 50, start: 6, accent: "#22C55E" },
          ],
          strength: { base: 0, weights: { cap: 1 } },
          maxStrength: 50,
          strengthWords: [
            { min: 0, text: "Small cap · poca liquidez, muy volátil", tone: "bad" },
            { min: 2, text: "Mid cap", tone: "good" },
            { min: 10, text: "Large cap · líquida y más estable", tone: "good" },
          ],
          challenges: [
            { id: "c_m3s1_1", prompt: "Muestra una small cap: lleva la capitalización por debajo de 2 mil millones.", compare: "lte", target: 1, successNote: "Small cap: poca liquidez, spreads anchos y movimientos porcentuales grandes en ambos sentidos." },
            { id: "c_m3s1_2", prompt: "Ahora muestra una large cap: lleva la capitalización por encima de 10 mil millones.", compare: "gte", target: 12, successNote: "Large cap: mucha liquidez y volatilidad relativa más contenida. El tamaño no es solo una etiqueta." },
          ],
          question: {
            prompt: "¿Qué distingue a una large cap de una small cap para un trader?",
            options: [
              { id: "a", text: "La large cap suele ser más líquida y menos volátil; la small cap, menos líquida y más volátil", correct: true, feedback: "Correcto. Lo viste en el medidor: el tamaño cambia la liquidez y la volatilidad esperada." },
              { id: "b", text: "La large cap no puede subir de precio", correct: false, feedback: "Claro que puede subir; solo tiende a hacerlo con movimientos porcentuales más moderados." },
              { id: "c", text: "La small cap siempre paga más dividendos", correct: false, feedback: "No hay relación garantizada entre tamaño y dividendos." },
              { id: "d", text: "No hay diferencia relevante para operar", correct: false, feedback: "La diferencia en liquidez y volatilidad afecta directamente el tamaño de posición y el riesgo." },
            ],
          },
          scene: {
            alt: "Distrito de rascacielos de Capital Corporativa",
            backdrop: { image: "/assets/missions/m3s_1-capitalizacion.webp" },
          },
        },
    ...
    // ── MISIÓN 3S.2 — Temporada de Resultados ──
    {
      ...
      description: "Cada trimestre, las empresas públicas reportan resultados. En el laboratorio moverás tú mismo la sorpresa en las ganancias (beat o miss) y la guía a futuro, y verás la reacción esperada del precio emerger en un medidor centrado — hasta inducir que el precio no reacciona al resultado, sino a la sorpresa, y que la guía puede pesar más que el trimestre ya cerrado.",
      learningObjectives: [
        "Inducir, moviendo sorpresa y guía, qué mueve realmente el precio tras un reporte",
        "Descubrir que un beat con guía a la baja puede dar una reacción mixta o negativa",
      ...
      outroDialogues: [
        { id: "m3s2_outro_1", character: "aria", type: "tip", text: "Lo viste en el medidor: subiste el EPS a un beat y, al recortar la guía, la reacción se apagó hasta volverse mixta o negativa. El precio no reacciona al resultado, sino a la sorpresa — y el mercado mira hacia adelante: la guía pesa tanto como el trimestre que cerró." },
      ...
      minigame: {
        id: "mg_m3s2", type: "level_lab", title: "El Reporte de Resultados",
        description: "Mueve la sorpresa en las ganancias (beat/miss) y la guía a futuro, y observa la reacción esperada del precio en un medidor centrado.",
        instructions: "El medidor crece a la derecha (alcista) o a la izquierda (bajista) desde el centro. Explóralo y luego resuelve los retos.",
        config: {
          region: "meter",
          regionLabel: "Reacción esperada del precio",
          centered: true,
          roleName: "",
          inputs: [
            { key: "eps", label: "Sorpresa en EPS (−3 miss · +3 beat)", min: -3, max: 3, start: 1, accent: "#22C55E" },
            { key: "guia", label: "Guía a futuro (−3 recorta · +3 sube)", min: -3, max: 3, start: 0, accent: "#818CF8" },
          ],
          strength: { base: 0, weights: { eps: 1, guia: 1 } },
          maxStrength: 6,
          strengthWords: [
            { min: -6, text: "Reacción bajista", tone: "bad" },
            { min: -1, text: "Mixta · sin sorpresa clara", tone: "bad" },
            { min: 2, text: "Reacción alcista", tone: "good" },
          ],
          challenges: [
            { id: "c_m3s2_1", prompt: "Dibuja la reacción más alcista: un beat en EPS acompañado de una guía al alza.", compare: "gte", target: 4, successNote: "Beat + guía al alza: el resultado y el futuro apuntan igual. Esa es la reacción alcista fuerte." },
            { id: "c_m3s2_2", prompt: "Ahora un beat que decepciona: el EPS queda fijo en positivo — baja solo la guía y mira qué pasa.", lock: "eps", compare: "lte", target: 0, successNote: "Un beat con guía a la baja se apaga: el mercado mira hacia adelante y la guía pesa más que el trimestre cerrado." },
          ],
          question: {
            prompt: "Una empresa supera el EPS esperado (beat) pero recorta su guía. ¿Qué reacción es más probable?",
            options: [
              { id: "a", text: "Mixta o incluso negativa: el mercado valora más las expectativas futuras que el resultado ya pasado", correct: true, feedback: "Correcto. Lo viste: con el EPS fijo en un beat, recortar la guía llevó el medidor hacia lo mixto/negativo." },
              { id: "b", text: "Claramente alcista, porque el trimestre reportado fue bueno", correct: false, feedback: "El trimestre ya se conocía; el mercado reacciona a la sorpresa y a la guía hacia adelante." },
              { id: "c", text: "Ningún movimiento: la guía no afecta al precio", correct: false, feedback: "La guía suele pesar tanto como el resultado, o más." },
              { id: "d", text: "Depende solo del ingreso, nunca de la guía", correct: false, feedback: "La guía es uno de los factores de mayor peso en la reacción." },
            ],
          },
          scene: {
            alt: "Sala de resultados de Capital Corporativa, pantallas de EPS",
            backdrop: { image: "/assets/missions/m3s_2-resultados.webp" },
          },
        },
    ...
    // ── MISIÓN 3S.3 — Dividendos y Acciones Corporativas ──
    {
      ...
      description: "Aprenderás a distinguir los eventos que confunden a más principiantes. En el laboratorio tendrás dos controles: el ajuste técnico (split / ex-dividendo) y un cambio real en los fundamentales. Moverás ambos y descubrirás que el ajuste técnico no mueve tu valor real — solo una noticia real lo hace.",
      learningObjectives: [
        "Inducir que un split o un ajuste ex-dividendo no cambian el valor real de tu inversión",
        "Descubrir que solo un cambio en los fundamentales mueve el valor real",
      ...
      outroDialogues: [
        { id: "m3s3_outro_1", character: "aria", type: "tip", text: "Lo comprobaste tú: por más que movías el ajuste técnico, el medidor de tu valor real no se movía — solo lo movió el cambio en los fundamentales. Un split cambia el número de acciones y el precio nominal, no el valor total; un ajuste ex-dividendo no es una pérdida; una recompra es una señal moderadamente positiva, sin garantía." },
      ...
      minigame: {
        id: "mg_m3s3", type: "level_lab", title: "¿Ajuste o Señal Real?",
        description: "Mueve el ajuste técnico (split / ex-dividendo) y el cambio en los fundamentales, y observa cuál mueve de verdad tu valor real.",
        instructions: "Primero mueve el ajuste técnico al máximo y observa el medidor. Luego mueve los fundamentales. Después resuelve los retos.",
        config: {
          region: "meter",
          regionLabel: "Valor real de tu inversión",
          centered: true,
          roleName: "",
          inputs: [
            { key: "ajuste", label: "Ajuste técnico (split / ex-dividendo)", min: 0, max: 5, start: 2, accent: "#818CF8" },
            { key: "fundamentales", label: "Cambio en los fundamentales (noticia real)", min: -3, max: 3, start: 0, accent: "#22C55E" },
          ],
          strength: { base: 0, weights: { ajuste: 0, fundamentales: 1 } },
          maxStrength: 3,
          strengthWords: [
            { min: -3, text: "Valor real: cayó", tone: "bad" },
            { min: 0, text: "Valor real: sin cambios", tone: "good" },
            { min: 1, text: "Valor real: subió", tone: "good" },
          ],
          challenges: [
            { id: "c_m3s3_1", prompt: "Sube tu valor real de verdad. (Pista: prueba primero el ajuste técnico y observa que no basta.)", compare: "gte", target: 2, successNote: "Solo el cambio en los fundamentales movió tu valor. El ajuste técnico —split o ex-dividendo— no lo tocó." },
            { id: "c_m3s3_2", prompt: "Ahora haz caer tu valor real con una noticia real mala.", compare: "lte", target: -2, successNote: "Otra vez: solo los fundamentales. Un split o un ajuste ex-dividendo cambian el número, no el valor total." },
          ],
          question: {
            prompt: "Tu acción hace un split 2:1 y su precio nominal cae a la mitad. ¿Qué le pasó a tu valor?",
            options: [
              { id: "a", text: "Nada: tienes el doble de acciones a la mitad de precio; el valor total es el mismo", correct: true, feedback: "Correcto. Lo viste: el ajuste técnico no movió el medidor de tu valor real." },
              { id: "b", text: "Perdiste la mitad de tu dinero", correct: false, feedback: "No: el número de acciones se duplicó, así que el total no cambió." },
              { id: "c", text: "Duplicaste tu dinero", correct: false, feedback: "Un split no crea valor; es aritmética, no una ganancia." },
              { id: "d", text: "Es imposible saberlo", correct: false, feedback: "Es directo: doble de acciones × mitad de precio = mismo total." },
            ],
          },
          scene: {
            alt: "Capital Corporativa: tablero de eventos corporativos",
            backdrop: { image: "/assets/missions/m3s_3-corporativo.webp" },
          },
        },
        passingScore: 66, virtualCapitalReward: 150,
      },
    ...
    // ── MISIÓN 3S.4 — Rotación Sectorial y Beta ──
    {
      ...
      description: "El dinero institucional rota entre sectores según la fase del ciclo. En el laboratorio moverás tú mismo el beta de un sector y verás en un medidor cuánto amplifica al mercado — hasta inducir por qué un beta alto lidera en expansión pero cae más fuerte cuando el ciclo gira, y un beta bajo defiende.",
      learningObjectives: [
        "Inducir, moviendo el beta, cuánto amplifica un sector los movimientos del mercado",
        "Distinguir sectores cíclicos (alto beta) de defensivos (bajo beta)",
      ...
      outroDialogues: [
        { id: "m3s4_outro_1", character: "aria", type: "tip", text: "Lo viste en el medidor: un beta alto amplifica al mercado en ambos sentidos — por eso los cíclicos (tecnología, consumo discrecional, industriales) lideran en expansión pero caen más al girar el ciclo; un beta bajo (utilities, consumo básico, salud) amortigua y defiende en contracción." },
      ...
      minigame: {
        id: "mg_m3s4", type: "level_lab", title: "El Indicador de Beta",
        description: "Mueve el beta de un sector y observa cuánto amplifica los movimientos del mercado.",
        instructions: "El medidor muestra la amplificación; la línea marca el beta 1.0 (igual que el mercado). Explóralo y resuelve los retos.",
        config: {
          region: "meter",
          regionLabel: "Amplificación del sector (beta)",
          thresholdAt: 100,
          roleName: "",
          inputs: [
            { key: "beta", label: "Beta del sector (×100: 30 = 0.30 · 160 = 1.60)", min: 30, max: 160, start: 100, accent: "#22C55E" },
          ],
          strength: { base: 0, weights: { beta: 1 } },
          maxStrength: 160,
          strengthWords: [
            { min: 0, text: "Defensivo · bajo beta, aguanta las caídas", tone: "good" },
            { min: 80, text: "Neutral · se mueve como el mercado", tone: "good" },
            { min: 110, text: "Cíclico · alto beta, amplifica en ambos sentidos", tone: "bad" },
          ],
          challenges: [
            { id: "c_m3s4_1", prompt: "Muestra un sector defensivo: lleva el beta muy por debajo de 1.0.", compare: "lte", target: 60, successNote: "Bajo beta: se mueve menos que el mercado. Aguanta mejor las caídas — útil en contracción o incertidumbre." },
            { id: "c_m3s4_2", prompt: "Ahora un sector cíclico: lleva el beta muy por encima de 1.0.", compare: "gte", target: 120, successNote: "Alto beta: amplifica el mercado en ambos sentidos. Lidera en expansión, pero cae más fuerte cuando el ciclo gira." },
          ],
          question: {
            prompt: "Un sector tiene beta 1.5. Si el mercado sube 10%, ¿qué sugiere el beta (en promedio histórico)?",
            options: [
              { id: "a", text: "Que el sector tiende a subir ~15%: amplifica el movimiento del mercado", correct: true, feedback: "Correcto. Lo viste: beta alto amplifica. 1.5 × 10% ≈ 15%, en la misma dirección." },
              { id: "b", text: "Que sube exactamente 10%, igual que el mercado", correct: false, feedback: "Eso sería beta 1.0; con 1.5 el movimiento es amplificado." },
              { id: "c", text: "Que baja 15%, en dirección opuesta", correct: false, feedback: "Un beta positivo se mueve en la misma dirección que el mercado, no opuesta." },
              { id: "d", text: "Que el beta no dice nada sobre el movimiento esperado", correct: false, feedback: "El beta es justamente la sensibilidad esperada frente al mercado." },
            ],
          },
          scene: {
            alt: "Capital Corporativa: panel de rotación sectorial",
            backdrop: { image: "/assets/missions/m3s_4-beta.webp" },
          },
        },
