...
export const level2: Level2Config = {
  ...
  missions: [
    ...
    // ──────────────────────────────────────────────────────
    {
      ...
      description: "Descubre las zonas moviéndolas tú: haz que el precio salga con fuerza de una zona y mira cómo se vuelve fuerte; deja que la retesteen y mírala debilitarse.",
      learningObjectives: [
        "Descubrir que una zona nace de una salida fuerte del precio (un desequilibrio)",
        "Ver que una zona fresca (sin retesteo) es más fuerte que una quemada",
        "Reconocer que cada retesteo consume parte de la zona",
      ],
      ...
      introDialogues: [
        ...
        { id: "m2_1_intro_3", character: "aria", type: "aria_message", text: "No te defino nada. Tienes una zona y dos mandos: con cuánta fuerza salió el precio de ella, y cuántas veces volvió a tocarla. Muévelos y mira qué le pasa a su fuerza." },
      ...
      outroDialogues: [
        { id: "m2_1_outro_1", character: "aria", type: "tip", text: "Lo viste: una zona nace de una salida fuerte del precio, y es más poderosa cuando aún está fresca. Cada vez que el precio vuelve a tocarla, consume parte de sus órdenes y la va quemando. Fresca y fuerte = mayor probabilidad de reacción." },
      ...
      minigame: {
        ...
        type: "level_lab",
        title: "Las Zonas del Poder",
        description: "Haz que el precio salga con fuerza de una zona y mírala fortalecerse. Deja que la retesteen y mírala quemarse.",
        instructions: "Sube la fuerza de salida y observa. Luego sube los retesteos. Resuelve los dos retos y responde qué hace fuerte a una zona.",
        config: {
          region: "band",
          roleName: "Zona de demanda",
          inputs: [
            { key: "impulso", label: "¿Con cuánta fuerza salió el precio de esta zona?", min: 0, max: 6, start: 2, accent: "#33b77a" },
            { key: "retesteos", label: "¿Cuántas veces el precio volvió a tocarla?", min: 0, max: 5, start: 0, accent: "#5d6e8c" },
          ],
          strength: { base: 0, weights: { impulso: 1, retesteos: -1 } },
          maxStrength: 6,
          strengthWords: [
            { min: -5, text: "quemada", tone: "bad" },
            { min: 2, text: "válida", tone: "good" },
            { min: 4, text: "fresca y fuerte", tone: "good" },
          ],
          ticksFrom: "retesteos",
          scene: {
            alt: "Mercado Plaza: zonas de oferta y demanda",
            backdrop: { image: "/assets/missions/m2_1-plaza.webp" },
          },
          challenges: [
            {
              id: "fresca",
              ...
              compare: "gte",
              target: 4,
              prompt: "Haz una zona fresca y fuerte: mucha fuerza de salida y sin retesteos.",
              successNote: "Una salida fuerte deja órdenes sin ejecutar: por eso una zona fresca reacciona con fuerza cuando el precio vuelve.",
            },
            {
              id: "quemada",
              metric: "strength",
              ...
              compare: "lte",
              target: 1,
              prompt: "Ahora quémala: deja que el precio la retestee varias veces.",
              successNote: "Cada retesteo consume parte de las órdenes de la zona. Muchos toques la dejan casi sin fuerza: quemada.",
            },
          ],
          question: {
            prompt: "¿Qué hace FUERTE a una zona de demanda?",
            options: [
              { id: "a", text: "Que el precio salió de ella con fuerza y aún no la han retesteado", correct: true, feedback: "Eso viste: salida fuerte + fresca = zona poderosa. Los retesteos la iban quemando." },
              { id: "b", text: "Que el precio la haya tocado muchas veces", correct: false, feedback: "Al revés: cada toque la debilita. Muchos toques = quemada." },
              { id: "c", text: "Que sea muy ancha", correct: false, feedback: "El ancho no la hace fuerte; la fuerza viene del impulso de salida y de estar fresca." },
              { id: "d", text: "Que esté cerca del precio actual", correct: false, feedback: "La cercanía no la hace fuerte; lo hacen el impulso de salida y no haber sido retesteada." },
            ],
          },
        },
        passingScore: 60,
    ...
    // ──────────────────────────────────────────────────────
    {
      ...
      description: "Descubre los niveles moviéndolos tú: fabrica un soporte fuerte haciendo que el precio rebote ahí, y mira qué pasa cuando lo rompes.",
      learningObjectives: [
        "Descubrir que un nivel se fortalece cuanto más rebota el precio en él",
        "Ver el role reversal: un soporte roto se convierte en resistencia",
        "Reconocer la diferencia entre soporte y resistencia por dónde reacciona el precio",
      ],
      ...
      introDialogues: [
        ...
        { id: "m2_2_intro_2", character: "aria", type: "aria_message", text: "No te doy las definiciones. Tienes un nivel en el gráfico y dos mandos: cuántas veces el precio rebota en él, y un botón para romperlo. Muévelos y mira qué pasa con su fuerza y con su nombre." },
      ...
      outroDialogues: [
        { id: "m2_2_outro_1", character: "aria", type: "tip", text: "Lo viste: cuantas más veces el precio rebota en un nivel, más fuerte se vuelve. Y al romperlo, cambia de rol — un soporte roto pasa a ser resistencia (role reversal). Ese es el mapa del precio." },
      ...
      minigame: {
        ...
        type: "level_lab",
        title: "El Mapa del Precio",
        description: "Haz que el precio rebote en un nivel y míralo fortalecerse. Rómpelo y descubre en qué se convierte.",
        instructions: "Sube los rebotes para fortalecer el nivel. Luego rómpelo. Resuelve los dos retos y responde qué pasa al romper un soporte.",
        config: {
          region: "line",
          reversal: { before: "Soporte", after: "Resistencia", toggleLabel: "Romper el nivel" },
          inputs: [
            { key: "toques", label: "¿Cuántas veces el precio rebotó en este nivel?", min: 0, max: 6, start: 1, accent: "#8b72ff" },
          ],
          strength: { base: 0, weights: { toques: 1 } },
          maxStrength: 6,
          strengthWords: [
            { min: 0, text: "débil", tone: "bad" },
            { min: 2, text: "medio", tone: "bad" },
            { min: 4, text: "fuerte", tone: "good" },
          ],
          ticksFrom: "toques",
          scene: {
            alt: "Observatorio: niveles del precio",
            backdrop: { image: "/assets/missions/m2_2-observatory.webp" },
          },
          challenges: [
            {
              id: "fuerte",
              ...
              compare: "gte",
              target: 4,
              prompt: "Haz un soporte fuerte: que el precio rebote varias veces en él.",
              successNote: "Cuantas más veces rebota el precio en un nivel, más fuerte se vuelve: más gente lo mira y opera ahí.",
            },
            {
              id: "romper",
              metric: "broken",
              compare: "gte",
              target: 1,
              prompt: "Ahora rompe el nivel y mira en qué se convierte.",
              successNote: "Al romperse, el soporte cambia de rol y pasa a ser resistencia. Eso es el role reversal.",
            },
          ],
          question: {
            prompt: "El precio rompió tu soporte hacia abajo. Cuando vuelva a subir hasta ese nivel, ¿qué será ahora?",
            options: [
              { id: "a", text: "Resistencia: un soporte roto se convierte en resistencia", correct: true, feedback: "Eso viste al romperlo: el nivel cambia de rol. Es el role reversal." },
              { id: "b", text: "Seguirá siendo soporte igual que antes", correct: false, feedback: "No: al romperlo dejó de sostener; ahora frena desde arriba." },
              { id: "c", text: "Deja de importar", correct: false, feedback: "Al contrario: el mercado recuerda ese nivel y reacciona en él." },
              { id: "d", text: "Se convierte en zona de demanda", correct: false, feedback: "El role reversal lo vuelve resistencia, no zona de demanda." },
            ],
          },
        },
        passingScore: 66,
    ...
    // ──────────────────────────────────────────────────────
    {
      ...
      description: "Descubre los patrones de vela formándolos tú: dale forma a una vela y mira qué patrón aparece. Luego, por qué un patrón sin contexto no vale nada.",
      learningObjectives: [
        "Descubrir que cada patrón (doji, martillo, estrella fugaz) es una forma concreta de cuerpo y mechas",
        "Reconocer un martillo y una estrella fugaz por su silueta",
        "Entender que un patrón solo vale en su contexto (zona y tendencia)",
      ],
      ...
      introDialogues: [
        ...
        { id: "m2_3_intro_2", character: "aria", type: "aria_message", text: "No te voy a listar los patrones. Dale forma a una vela —cuerpo y mechas— y mira qué nombre aparece. Descubre tú qué silueta es un martillo y cuál una estrella fugaz." },
      ...
      outroDialogues: [
        { id: "m2_3_outro_1", character: "aria", type: "tip", text: "Lo formaste tú: cada patrón es una silueta de cuerpo y mechas. Pero ojo — un patrón solo es el 30% de la información. Un martillo en zona de demanda vale; el mismo en medio de la nada, no. Combínalo siempre con la estructura." },
      ...
      minigame: {
        ...
        description: "Dale forma a la vela y mira qué patrón aparece. Descubre qué silueta es cada uno.",
        instructions: "Mueve los cuatro precios y observa el nombre del patrón. Resuelve los dos retos y responde qué es un martillo.",
        config: {
          priceMin: 2,
          priceMax: 20,
          open: { start: 11 },
          ...
          showPattern: true,
          scene: {
            alt: "Taller de Velas: patrones",
            backdrop: { image: "/assets/missions/m2_3-patterns.webp" },
          },
          challenges: [
            {
              id: "martillo",
              ...
              compare: "gte",
              target: 5,
              prompt: "Haz un martillo: cuerpo pequeño arriba y una mecha inferior larga.",
              successNote: "Cuerpo pequeño y mecha inferior larga = martillo. Muestra que el precio bajó y fue rechazado con fuerza.",
            },
            {
              id: "estrella",
              metric: "upperWick",
              compare: "gte",
              target: 5,
              prompt: "Ahora una estrella fugaz: cuerpo pequeño abajo y una mecha superior larga.",
              successNote: "Cuerpo pequeño y mecha superior larga = estrella fugaz: un rechazo de precios altos.",
            },
          ],
          question: {
            prompt: "¿Qué hace que una vela sea un 'martillo'?",
            options: [
              { id: "a", text: "Un cuerpo pequeño con una mecha inferior larga", correct: true, feedback: "Eso formaste: la mecha inferior larga es la firma del martillo — el precio bajó y fue rechazado." },
              { id: "b", text: "Un cuerpo muy grande", correct: false, feedback: "Un cuerpo grande es otra cosa; el martillo tiene cuerpo pequeño." },
              { id: "c", text: "Una mecha superior larga", correct: false, feedback: "Eso es una estrella fugaz, el patrón opuesto." },
              { id: "d", text: "Que sea verde", correct: false, feedback: "El color no define el martillo; lo define su silueta (mecha inferior larga)." },
            ],
          },
        },
        passingScore: 70,
